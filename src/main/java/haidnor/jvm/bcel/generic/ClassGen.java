...
public class ClassGen extends AccessFlags implements Cloneable {
     ...
     */
    public void addField(final JavaField f) {
        fieldList.add(f);
    }
     ...
     */
    public void addMethod(final JavaMethod m) {
        methodList.add(m);
    }
    ...
    public boolean containsField(final JavaField f) {
     ...
     */
    public JavaField containsField(final String name) {
        for (final JavaField f : fieldList) {
     ...
     */
    public JavaMethod containsMethod(final String name, final String signature) {
        for (final JavaMethod m : methodList) {
    ...
    public JavaClass getJavaClass() {
        ...
        final JavaField[] fields = getFields();
        final JavaMethod[] methods = getMethods();
     ...
     */
    public void removeField(final JavaField f) {
        fieldList.remove(f);
    }
     ...
     */
    public void removeMethod(final JavaMethod m) {
        methodList.remove(m);
    }
     ...
     */
    public void replaceField(final JavaField old, final JavaField newField) {
        if (newField == null) {
     ...
     */
    public void replaceMethod(final JavaMethod old, final JavaMethod newMethod) {
        if (newMethod == null) {
            throw new ClassGenException("Replacement method must not be null");
        }
