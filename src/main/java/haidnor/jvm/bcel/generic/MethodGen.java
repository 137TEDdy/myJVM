...
public class MethodGen extends FieldGenOrMethodGen {
    ...
    public MethodGen copy(final String className, final ConstantPoolGen cp) {
        final JavaMethod m = ((MethodGen) clone()).getMethod();
    ...
    public JavaMethod getMethod() {
        ...
        final JavaMethod m = new JavaMethod(super.getAccessFlags(), nameIndex, signatureIndex, getAttributes(), cp.getConstantPool());
